# python-bitcoinlib-zcash

Zcash fork of [python-bitcoinlib](https://github.com/petertodd/python-bitcoinlib) with **Orchard shielded transactions** (Halo2, no trusted setup).
...
| Metric | Value |
|--------|-------|
| Original | [petertodd/python-bitcoinlib](https://github.com/petertodd/python-bitcoinlib) |
| Language | Python |
| Source files | 63 |
| RPC calls detected | 15 |
| Code changes applied | 581 |
| Framework | python-package |
| RPC calls mapped | 113 |
| Shielded methods | getnewaddress, listunspent, importprivkey, validateaddress, dumpprivkey, getbalance, sendtoaddress |
...
| `zcash-enhancements/MIGRATION-MAP.md` | 113 RPC calls mapped to Zcash |
...
```bash
git clone https://github.com/Michae2xl/python-bitcoinlib-zcash.git
cd python-bitcoinlib-zcash/zcash-enhancements
