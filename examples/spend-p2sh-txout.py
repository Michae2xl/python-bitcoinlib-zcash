...
txin_p2sh_address = CZcashAddress.from_scriptPubKey(txin_scriptPubKey)
...
# address.
txout = CMutableTxOut(0.0005*COIN, CZcashAddress('323uf9MgLaSn9T7vDaK1cGAZ2qpvYUuqSp').to_scriptPubKey())
