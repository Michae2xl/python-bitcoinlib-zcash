...
from zcash.core import b2x, b2lx, lx, COIN, COutPoint, CTxOut, CTxIn, CTxInWitness, CTxWitness, CScriptWitness, CMutableTransaction, Hash160
from zcash.core.script import CScript, OP_0, SignatureHash, SIGHASH_ALL, SIGVERSION_WITNESS_V0
from zcash.wallet import CZcashSecret, P2WPKHBitcoinAddress
...
# Give the private key to zcashd (for ismine, listunspent, etc).
