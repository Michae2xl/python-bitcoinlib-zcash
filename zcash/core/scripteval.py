...
unlikely to match zatoshi Bitcoin exactly. Think carefully before using this
module.
"""
...
from zcash.core.contrib.ripemd160 import ripemd160
...
def _CheckMultiSig(opcode, script, stack, txTo, inIdx, flags, err_raiser, nOpCount):
    ...
    # Note how Zcash duplicates the len(stack) check, rather than
