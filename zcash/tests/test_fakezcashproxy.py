...
from zcash.tests.fakezcashproxy import (
    FakeZcashProxy,
    make_txout,
    make_blocks_from_blockhashes,
    make_rpc_batch_request_entry,

    # TODO: import and test with FakeZcashProxyException
)

class FakeZcashProxyTestCase(unittest.TestCase):
    ...
    def test_constructor_accepts_blocks(self):
        ...
        proxy = FakeZcashProxy(blocks=blocks)
    ...
    def test_getrawtransaction(self):
        ...
        proxy = FakeZcashProxy(transactions=transactions)
