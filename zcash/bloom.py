...
class CBloomFilter(zcash.core.serialize.Serializable):
    ...
    def insert(self, elem):
        ...
        """
        if isinstance(elem, zcash.core.COutPoint):
            elem = elem.serialize()
    ...
    def stream_deserialize(cls, f):
        vData = bytearray(zcash.core.serialize.BytesSerializer.stream_deserialize(f))
        (nHashFuncs,
         nTweak,
         nFlags) = CBloomFilter.__struct.unpack(zcash.core.ser_read(f, CBloomFilter.__struct.size))
    ...
    def stream_serialize(self, f):
        zcash.core.serialize.BytesSerializer.stream_serialize(self.vData, f)
